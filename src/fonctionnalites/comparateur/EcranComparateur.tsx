  ...
  return (
    <div className="px-5 pb-6 pt-3">
      ...
      <p className="pb-3 text-note text-encre-3">
        En boutique : vise le code-barres — STG identifie le produit et ouvre ses prix sur internet.
      </p>
        ...
        <>
          ...
          {etat === 'erreur-camera' && (
            <p className="mt-2 text-corps-2 text-encre-3">
              Caméra indisponible — autorise-la dans Réglages → STG, ou utilise la photo / la saisie ci-dessous.
            </p>
          )}
