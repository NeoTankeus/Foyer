...
export const NOTES_VERSION: string[] = [
  ...
  '🌊 « Chez nous » a désormais son propre guide écrit à la main : Toulon, la rade et le Var — le cours Lafayette, la cade, le Mourillon, le Faron, le bateau-bus de Saint-Mandrier, Sanary, les vins de Bandol, Giens, Porquerolles, Le Castellet. Plus besoin de l’IA pour avoir des adresses chez soi.',
  '🧪 Le banc d’essai va plus loin : il REMPLIT les formulaires, les valide, et détecte aussi les affichages abîmés (« undefined », « NaN », « Invalid Date ») sur les 62 écrans, en données normales ET en données volontairement cassées.',
  '🛡️ Une douzaine de nouveaux garde-fous : un prénom, un nom de commerce ou un type de bien vides ne peuvent plus faire tomber un écran (pastilles des membres, Personnes, Immobilier, Garde, Stock).',
