...
const EcranTrafic = paresseux(() => import('@/fonctionnalites/trafic/EcranTrafic'), 'EcranTrafic')
...
function IconeOnglet({ nom }: { nom: string }) {
  ...
  switch (nom) {
    case 'aujourdhui':
      // Un soleil : « la journée en cours ». Les deux vaguelettes d'avant ne
      // voulaient rien dire pour personne.
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
          <circle cx="12" cy="12" r="4.2" {...traits} />
          <path
      ...
      <div className="relative flex h-dvh flex-col overflow-hidden bg-fond">
        ...
        <Suspense fallback={<div className="min-h-dvh bg-fond" aria-busy="true" />}>
          ...
          <Routes>
            ...
            <Route path="/nous/trafic" element={<EcranTrafic />} />
